    ...
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {/* Free Plan */}
          <div className="bg-white/30 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg">
            <div className="p-6">
            ...
            <div className="bg-black/10 p-6">
              <ul className="space-y-3">
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-team-accent mr-2" strokeWidth={2.5} />
                  <span className="text-white text-sm">WhatsApp API</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-team-accent mr-2" strokeWidth={2.5} />
                  <span className="text-white text-sm">50 Contacts</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-team-accent mr-2" strokeWidth={2.5} />
          ...
          {/* Standard Plan */}
          <div className="bg-white/40 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg relative transform md:-translate-y-4">
            ...
            <div className="bg-black/15 p-6">
              <ul className="space-y-3">
                ...
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-team-accent mr-2" strokeWidth={2.5} />
                  <span className="text-white text-sm">2,000 Contacts</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-team-accent mr-2" strokeWidth={2.5} />
                  <span className="text-white text-sm">AI Message Writer</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-team-accent mr-2" strokeWidth={2.5} />
          ...
          <div className="bg-white/30 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="bg-black/10 p-6">
              <ul className="space-y-3">
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-team-accent mr-2" strokeWidth={2.5} />
                  <span className="text-white text-sm">Everything in Standard</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-team-accent mr-2" strokeWidth={2.5} />
                  <span className="text-white text-sm">Unlimited Campaigns</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-team-accent mr-2" strokeWidth={2.5} />
                  <span className="text-white text-sm">Team Roles & Permissions</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-team-accent mr-2" strokeWidth={2.5} />
